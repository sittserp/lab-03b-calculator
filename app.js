...
import { handleAddClick, handleMultiplyClick, handleSubtractionClick, handleDivisionClick } from './clickHandlers.js';
...
xButton.addEventListener('click', handleMultiplyClick);
minusButton.addEventListener('click', handleSubtractionClick);
divideButton.addEventListener('click', handleDivisionClick);
